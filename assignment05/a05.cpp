...
int main() {
	do {
		...
		cout << "b. quit this program" << endl << endl;
		cin >> optionsChar;
		if (optionsChar == 'b') {
			return 0;
		}
...
void welcome() {
	...
	cout << "The cost to become a member of the fitClub center is as follows:" << endl << endl;
	...
	cout << "The senior citizens discount is " << SENIOR_DISCOUNT * 100 << "% off the total amount." << endl << endl;
};
...
void printQuote() {
	cout << "Your membership cost after the " << MEMBERSHIP_PRE_PAY_DISCOUNT * 100 << "% off is $" << membershipCost << endl << endl;

	cout << "Your personal training cost for " << personal << " sessions is $" << personalTrainCost << endl << endl;

	cout << "Your total membership cost is $" << membershipCost + personalTrainCost << "." << endl << endl;

	if (senior) {
	cout << "After your Senior discount, your membership cost is $" << totalCost << endl << endl;
	}

	cout << "Thank you for checking out my fitclub center!! Come back and be fit!" << endl << endl;
};